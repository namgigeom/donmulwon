...
class PixelCharacter:
 ...
 def paint(self,p,x,y,scale=3):
  main,dark,accent=SPECS[self.name]; s=max(1,int(scale)); x=int(x); y=int(y)
  def r(a,b,c,d,col): p.setBrush(QColor(col)); p.drawRect(x+a*s,y+b*s,c*s,d*s)
  p.setPen(Qt.NoPen)
  # compact top-down pixel sprite
  r(4,20,16,3,'#171719'); r(4,10,16,10,dark); r(2,12,4,6,dark); r(18,12,4,6,dark)
  r(8,11,8,7,'#eee6d4'); r(11,11,2,8,accent); r(6,3,12,9,main); r(8,1,8,3,main)
  if self.name=='알프레도':
   r(6,2,3,4,main); r(15,2,3,4,main); r(7,6,10,4,'#202228')
...
class CharacterLayer:
 # Dedicated desk seats: each sprite is centered under its own monitor.
 POSITIONS={'현무':(151,286,0),'김선달':(416,286,0),'이묵':(681,286,0),'너부리':(946,286,0),'알프레도':(1270,286,0)}
